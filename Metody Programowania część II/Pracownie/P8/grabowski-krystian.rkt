...
(define (swap e env)
  (cond [(const? e) e]
        [(var?   e) (if (exists-in-env? e env)
                        (find-in-env e env)
                        e)]
        [(let?   e) (let-cons (list (let-def-var e) (swap (let-def-expr e)))
                              (swap (let-expr e) (add-to-env (let-def-var e)
                                                         (let-def-expr e))))]
        [(lazy-let? e) (list 'lazy-let
                             (list (let-def-var e) (swap (let-def-expr e)))
                             (swap (let-expr e) (add-to-env (let-def-var e)
                                                         (let-def-expr e))))]
