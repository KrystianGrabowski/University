...
public class Korty extends Obiekt_Sportowy{
	public Pracownicy P;
	public Klienci K;
	public int nr_lokalu;
	public String zapisP = "pracownicyK.txt", zapisK = "klienciK.txt";
	public Korty(String n, String u, int nr, Integer t)
	{
	...
	public String nazwa()
	{
		return "Witamy w kortach " + nazwa;
	}
	public String kontakt()
	{
		return "Kontakt do kortow " + nazwa + " -> " + telefon;
	}
