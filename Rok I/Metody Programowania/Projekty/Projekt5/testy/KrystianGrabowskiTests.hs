...
tests =
  ...
  , Test "sqrt"     (SrcFile "apliksq.pp5")        (Eval [4] (Value 9))
  ...
  , Test "unitck"   (SrcFile "aplikun.pp5")        (Eval [6] (Value 12))
  ...
  , Test "pair3" (SrcFile "pairfsc.pp5")        (Eval [2,2] (Value 5))
  ...
  , Test "list1" (SrcFile "listempty.pp5")      (Eval [1,2,3] (Value 1))
