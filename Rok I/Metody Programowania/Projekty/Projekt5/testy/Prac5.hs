...
--
-- Sprawdzaczka pozwala zarówno sprawdziæ swoje rozwi¹zanie na w³asnych
-- testach, jak i uruchomiæ napisany ewaluator na dowolnym programie
--
-- Aby uruchomiæ swoje rozwi¹zanie na testach nale¿y uruchomiæ program
-- z flag¹ -t:
--
-- $ ./Prac5 -t
--
-- Aby uruchomiæ ewaluator na przygotowanym pliku z programem, przekazujemy
-- œcie¿kê do pliku (np. example.pp5) do sprawdzaczki:
--
-- $ ./Prac5 example.pp5
--
-- Dodatkowo flagi -u oraz -d pozwalaj¹ wy³¹czyæ sprawdzanie typów
-- i ewaluacje programu. Zatem mo¿na
--
-- * uruchomiæ program bez sprawdzania typów:
--   $ ./Prac5 -u example.pp5
-- * sprawdziæ typy bez uruchamiania programu:
--   $ ./Prac5 -d example.pp5
-- * tylko sparsowaæ program:
--   $ ./Prac5 -u -d example.pp5
{-# LANGUAGE Safe #-}

-- Nale¿y zmodyfikowaæ poni¿sze dwa wiersze zmieniaj¹c nazwy modu³ów
import qualified KrystianGrabowskiTests as Tests
import qualified KrystianGrabowski as Solution
