...
data Expr p
  = EVar    p Var                              -- Zmienna
  | ENum    p Integer                          -- Litera³ ca³kowitoliczbowy
  | EBool   p Bool                             -- Sta³a boolowska
  | EUnary  p UnaryOperator (Expr p)           -- Wyra¿enie operatorowe unarne
  | EBinary p BinaryOperator (Expr p) (Expr p) -- Wyra¿enie operatorowe
  | ELet    p Var (Expr p) (Expr p)            -- Wyra¿enie let
  | EIf     p (Expr p) (Expr p) (Expr p)       -- Wyra¿enie warunkowe
...
-- ============================================================================
-- Podstawowe operacje na wyra¿eniach i programach
